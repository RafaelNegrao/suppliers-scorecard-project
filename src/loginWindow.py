...
"}")
        ...
        self.widget.setStyleSheet("background-color:qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 rgba(255, 1, 1, 255), stop:1 rgba(255, 75, 0, 255))")
...
"")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/images/login-svgrepo-com.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_login.setIcon(icon1)
        self.btn_login.setIconSize(QtCore.QSize(24, 25))
        self.btn_login.setObjectName("btn_login")
        self.checkBox_remember_login = QtWidgets.QCheckBox(self.centralwidget)
        self.checkBox_remember_login.setGeometry(QtCore.QRect(294, 252, 115, 17))
        font = QtGui.QFont()
        font.setFamily("Poppins")
        font.setPointSize(8)
        self.checkBox_remember_login.setFont(font)
